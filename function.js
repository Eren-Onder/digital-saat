...
function tokyoSaatiGoster() {
  ...
  sifirEkle();
  let tokyoSaati = (document.getElementById("digital").innerHTML =
    saat + ":" + dakika + ":" + saniye);
...
function newYorkSaatiGoster() {
  ...
  saniye = dateTime.getSeconds();
  sifirEkle();
  let neWSaatiGoster = (document.getElementById("digital").innerHTML =
    saat + ":" + dakika + ":" + saniye);
...
function zurichSaatiGoster() {
  ...
  saniye = dateTime.getSeconds();
  sifirEkle();
  let zurichSaatiGoster = (document.getElementById("digital").innerHTML =
    saat + ":" + dakika + ":" + saniye);
